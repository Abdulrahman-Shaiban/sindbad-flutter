...
class ChangeProductFavoriteStatusInitial extends ChangeProductFavoriteStatusState {
  const ChangeProductFavoriteStatusInitial();
}

class ChangeProductFavoriteStatusLoading extends ChangeProductFavoriteStatusState {
  final int? index;
...
class ChangeProductFavoriteStatusLoaded extends ChangeProductFavoriteStatusState {
  ...
  bool operator ==(Object other) =>
      ...
      other is ChangeProductFavoriteStatusLoaded &&
          ...
          index == other.index &&
          favoriteStatus == other.favoriteStatus;

  @override
  int get hashCode =>
      message.hashCode ^
      index.hashCode ^
      favoriteStatus.hashCode;
...
class ChangeProductFavoriteStatusError extends ChangeProductFavoriteStatusState {
  final String error;
